...
public class SudokuFrame extends JFrame implements IObserver {
    ...
    public SudokuFrame(final ISudokuController controller) {
        ...
        resize9MenuItem.setAccelerator(KeyStroke.getKeyStroke(
                KeyEvent.VK_NUMBER_SIGN, 0));
        ...
        resize4MenuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_PLUS,
                0));
        ...
        resize1MenuItem.setAccelerator(KeyStroke.getKeyStroke(
